...
public class SortingTestWorkFlow {
    ...
    public SortingTestWorkFlow(String name, Test.TestRunnerParameters parameters, Metric metric, ISort<Integer> sort, SimpleSortingReport report) {
