...
public class App implements AutoCloseable {
    ...
    private void countingSortTest(Test.TestRunnerParameters parameters){
        ...
        final var testFlow = new SortingTestWorkFlow(name, parameters, metric, new CountingSort<>(comparator, exchangeMetrics, amounter), report);
        testFlow.run();
    }
